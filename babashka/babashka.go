...
// This is a copy from https://github.com/babashka/pod-babashka-fswatcher/blob/main/babashka/ops.go
// Added "Meta" key for Vars
...
type Var struct {
	Name string "name"
	Meta string `bencode:"meta,omitempty"`
